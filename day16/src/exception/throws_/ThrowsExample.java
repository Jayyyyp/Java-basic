...
public class ThrowsExample {
	 ...
	 * 예외처리를 메서드 호출지역으로 떠넘기는 방식을 throws라고 한다.
	 * 메서드 혹은 생성자 호출 시 예외처리를 강요하고 싶다면 사용한다.
	 */
	...
	public static void main(String[] args) {
		/*
		 * - throws 가 붙어있는 메서드나 생성자 호출 시에는
		 * try 블록 내부에서 호출해야 예외처리를 진행해 준다.
		 */
		try {
			greet(3); // 예외가 무조건 발생
		}catch(Exception e) {
